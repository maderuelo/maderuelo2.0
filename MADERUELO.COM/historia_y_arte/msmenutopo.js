...
function MenuItemOnMouseOver(obj) {
  ...
  obj.style.color = 'red'              // Change text to red (antes white)
...
function MenuItemOnMouseOut(obj) {
  ...
  obj.style.backgroundColor = '#ffebc1' //antes "transparent"
  obj.style.color = 'black'    // antes white
}
...
function MenuItemToString() 
{
  ...
  return "  <tr class=menuRow \n" +
         ...
         "    <td class=menuArrowCell noWrap=noWrap menuid=" + this.id + " " + 
           ((this.submenu != null) ? "style='font-family:Webdings;font-size: 12pt; font-weight: bold'>4" : "style='font-family:verdana; font-size: 12pt; font-weight: bold'>&nbsp;&nbsp;&nbsp;") + "</td>\n" +
         "  </tr>\n";
}
...
function MenuShow(noDisplay)
{
  ...
  if (noDisplay) 
  {
    ...
    menub1.style.background = '#ffebc1'
  }
}
